...
namespace directx {
	...
	public:
		...
		DNH_FUNCAPI_DECL_(Func_SaveGlyphs);
		...
		DNH_FUNCAPI_DECL_(Func_Obj_SetDeleteCallback);
...
#undef DEFINE_OBJVALUE_FUNC
		...
		DNH_FUNCAPI_DECL_(Func_ObjSpline_AddNode);
		DNH_FUNCAPI_DECL_(Func_ObjSpline_SetNode);
		DNH_FUNCAPI_DECL_(Func_ObjSpline_GetNode);
		DNH_FUNCAPI_DECL_(Func_ObjSpline_GetNodeCount);
		DNH_FUNCAPI_DECL_(Func_ObjSpline_GetArcLength);
		DNH_FUNCAPI_DECL_(Func_ObjSpline_Align);
		DNH_FUNCAPI_DECL_(Func_ObjSpline_Lerp);
		DNH_FUNCAPI_DECL_(Func_ObjSpline_LerpArc);
		...
		DNH_FUNCAPI_DECL_(Func_ObjSpring_SetNode);
		DNH_FUNCAPI_DECL_(Func_ObjSpring_GetNode);
		DNH_FUNCAPI_DECL_(Func_ObjSpring_RemoveNode);
		DNH_FUNCAPI_DECL_(Func_ObjSpring_AddSpring);
		DNH_FUNCAPI_DECL_(Func_ObjSpring_SetSpring);
		DNH_FUNCAPI_DECL_(Func_ObjSpring_GetSpring);
		DNH_FUNCAPI_DECL_(Func_ObjSpring_RemoveSpring);
		DNH_FUNCAPI_DECL_(Func_ObjSpring_AddPlane);
		...
		DNH_FUNCAPI_DECL_(Func_ObjRender_GetPosition);
		...
		DNH_FUNCAPI_DECL_(Func_ObjText_SetAtlas);
