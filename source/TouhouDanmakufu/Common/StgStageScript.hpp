...
public:
	...
	*/
	...
	DNH_FUNCAPI_DECL_(Func_ObjMove_AddPattern);
	...
	DNH_FUNCAPI_DECL_(Func_ObjMove_AddPatternE2);
	DNH_FUNCAPI_DECL_(Func_ObjMove_AddPatternE3);
	...
	DNH_FUNCAPI_DECL_(Func_ObjEnemy_SetDeathCallback);
	...
	DNH_FUNCAPI_DECL_(Func_ObjShot_IsDeleting);
	...
	DNH_FUNCAPI_DECL_(Func_ObjShot_SetAnimation);
